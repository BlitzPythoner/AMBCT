...
def welcome():
    ...
    print("Note: Currently, AMBCT supports only x64 systems yet. There will be a x32 soon.\n")
...
if "x86" in arch:
    input(f"Sorry, this version of AMBCT {__version__} doesn't support x86 systems yet!\n\nPress Enter to close this program...")
    sys.exit(-2)
